...
TANGENT_TYPES = ['spline', 'linear', 'fast', 'slow', 'flat', 'step', 'stepnext',
                 'fixed', 'clamped', 'plateau', 'auto', 'autoease', 'automix', 'autocustom']
...
class TimeKeyframe:
    ...
    def get_keyframe(self, x_value: float) -> KeyframeData:
        ...
        return KeyframeData(x_value=x_value, y_value=value,
                            in_tangent_type=in_tangent_type, out_tangent_type=out_tangent_type,
                            in_weight=in_weight, out_weight=out_weight,
                            in_angle=in_angle, out_angle=out_angle,
                            lock=lock)
    ...
    def set_keyframe(self, keyframe: KeyframeData):
        ...
        cmds.keyTangent(self.plug, time=(keyframe.x_value, keyframe.x_value),
...
class AttributeKeyframe:
    ...
    def set_keyframe(self, keyframe: KeyframeData, driver_plug: str):
        ...
        cmds.keyTangent(anim_curve, float=(keyframe.x_value, keyframe.x_value),
                        inTangentType=keyframe.in_tangent_type,
                        outTangentType=keyframe.out_tangent_type,
                        inWeight=keyframe.in_weight,
                        outWeight=keyframe.out_weight,
...
class TimeAnimCurve:
    ...
    def get_keyframes(self) -> AnimCurveData:
        ...
        return AnimCurveData(keyframes=keyframe_datas,
