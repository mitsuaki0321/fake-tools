...
class MainWindow(base_window.BaseMainWindow):
    ...
    _boundingbox_widgets = {'world': WorldBoxWidget,
                            'minimum': MinimumBoxWidget,
                            'axis_aligned': AxisAlignedBoxWidget}
    ...
    def __init__(self,
        ...
        for bounding_type in self._boundingbox_widgets.keys():
    ...
    def create_bounding_box(self):
        ...
        create_boundingbox.main(bounding_box_type=bounding_type,
                                box_type=box_type,
...
def show_ui():
    ...
    main_window = MainWindow(parent=maya_qt.get_maya_pointer(),
                             ...
                             window_title='BoundingBox Creator')
    main_window.show()
